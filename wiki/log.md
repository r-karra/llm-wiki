...
- **Cleanup**: Removed old travel-related content and updated `CLAUDE.md`.
- **Content Ingestion**: Ingested notebooks from `learn-quantum-AI` repository.
    - Updated [[topics/hands-on-llms]] with Chapter 2 notes.
